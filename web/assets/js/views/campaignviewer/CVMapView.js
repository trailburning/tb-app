  ...
  var MapView = Backbone.View.extend({
    ...
    render: function(){
      ...
      this.options.collectionPosts.each(function(modelPost) {
        var markerView = new MarkerView({model: modelPost, map: self.options.map, mapCluster: self.markerCluster});
        modelPost.markerView = markerView;
...
//      this.options.map.fitBounds(bounds, {padding: [50, 50], animate: false});
