define([
  ...
  var CampaignView = Backbone.View.extend({
    initialize: function(){
      ...
      var fLat, fLng, strTwitterSearch, bShowRetweets;
      ...
      this.twitterView = new TwitterView({ el: '#twitter_view', model: this.model, search: strTwitterSearch, bShowRetweets: bShowRetweets });
