...
define([
  ...
  var initialize = function() {
    ...
    function builtEventMap() {  
      ...
      var map = L.mapbox.map('event_location_map', 'mallbeury.gahmec5m', {dragging: false, touchZoom: false, scrollWheelZoom:false, doubleClickZoom:false, boxZoom:false, tap:false, zoomControl:false, zoomAnimation:false, attributionControl:false});
