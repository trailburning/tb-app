...
/* pages/class.twig */
class __TwigTemplate_dc9b5fe9f657a2a5cc1debacabeac0ed extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"] = $this->env->loadTemplate("macros.twig");
    ...
    <h1>";
        // line 11
        echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->getnamespace_link($this->getAttribute($this->getContext($context, "class"), "namespace"));
...
";
    ...
    ";
        ...
        if (($this->getAttribute($this->getContext($context, "class"), "shortdesc") || $this->getAttribute($this->getContext($context, "class"), "longdesc"))) {
            ...
            <p>";
            // line 19
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "class"), "shortdesc"), $this->getContext($context, "class"));
            echo "</p>
            <p>";
            // line 20
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "class"), "longdesc"), $this->getContext($context, "class"));
            echo "</p>
        </div>
    ";
        }
    ...
    public function block_class_signature($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getContext($context, "class"), "parent")) {
            // line 52
            echo "        extends ";
            echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->getclass_link($this->getAttribute($this->getContext($context, "class"), "parent"));
        }
        // line 54
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["interface"]) {
                // line 57
                echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->getclass_link($this->getContext($context, "interface"));
                // line 58
    ...
    public function block_method_signature($context, array $blocks = array())
    {
        ...
        // line 70
        echo "    ";
        echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->gethint_link($this->getAttribute($this->getContext($context, "method"), "hint"));
        echo "
    <strong>";
        // line 71
    ...
    {
        // line 75
        $context["__internal_b1f821739179412f5b7335fdf84da810ae68b1fa"] = $this->env->loadTemplate("macros.twig");
        // line 76
        echo $context["__internal_b1f821739179412f5b7335fdf84da810ae68b1fa"]->getmethod_parameters_signature($this->getContext($context, "method"));
    }
    ...
    public function block_parameters($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["parameter"]) {
            ...
            if ($this->getAttribute($this->getContext($context, "parameter"), "hint")) {
                echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->gethint_link($this->getAttribute($this->getContext($context, "parameter"), "hint"));
            }
            echo "</td>
                <td>\$";
            // line 84
            ...
            echo "</td>
                <td>";
            // line 85
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "parameter"), "shortdesc"), $this->getContext($context, "class"));
            echo "</td>
            </tr>
        ";
        }
...
";
    ...
    public function block_return($context, array $blocks = array())
    {
        ...
        echo "</td>
            <td>";
        // line 95
        echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "method"), "hintDesc"), $this->getContext($context, "class"));
        echo "</td>
        </tr>
    </table>
";
    ...
    public function block_exceptions($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["exception"]) {
            ...
            echo "            <tr>
                <td>";
            // line 104
            echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->getclass_link($this->getAttribute($this->getContext($context, "exception"), 0, array(), "array"));
            echo "</td>
                <td>";
            // line 105
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "exception"), 1, array(), "array"), $this->getContext($context, "class"));
            echo "</td>
            </tr>
        ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["constant"]) {
            ...
            echo "</td>
                <td class=\"last\">
                    <p><em>";
            // line 128
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "constant"), "shortdesc"), $this->getContext($context, "class"));
            echo "</em></p>
                    <p>";
            // line 129
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "constant"), "longdesc"), $this->getContext($context, "class"));
            echo "</p>
                </td>
            </tr>
        ";
...
";
    ...
    public function block_properties($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["property"]) {
            ...
            // line 143
            echo "                    ";
            echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->gethint_link($this->getAttribute($this->getContext($context, "property"), "hint"));
            echo "
                </td>
                <td>\$";
            // line 145
            ...
            echo "</td>
                <td class=\"last\">";
            // line 146
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "property"), "shortdesc"), $this->getContext($context, "class"));
            echo "</td>
            </tr>
        ";
        }
    ...
    public function block_methods($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["method"]) {
            ...
            echo "
                    <p>";
            // line 161
            echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "method"), "shortdesc"), $this->getContext($context, "class"));
            echo "</p>
                </td>
                <td>";
            // line 164
            if ((!($this->getAttribute($this->getContext($context, "method"), "class") === $this->getContext($context, "class")))) {
                // line 165
                echo "<small>from&nbsp;";
                echo $context["__internal_527af9ed89caabafa54c2a3af0f864223bc61e8f"]->getmethod_link($this->getContext($context, "method"), array(), false, true);
                echo "</small>";
            }
            // line 167
            echo "</td>
...
";
    ...
    <div class=\"details\">
        ...
        <p>";
        // line 186
        echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "method"), "longdesc"), $this->getContext($context, "class"));
        echo "</p>
        <div class=\"tags\">
            ";
        // line 188
