...
class __TwigTemplate_6e618a129feffb6d828c2bf704e24454 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_30af7d117510ba78a07f2b2311d790f6e406103f"] = $this->env->loadTemplate("macros.twig");
        ...
        if ($this->getContext($context, "classes")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["class"]) {
                ...
                echo "                <tr>
                    <td>";
                // line 19
                echo $context["__internal_30af7d117510ba78a07f2b2311d790f6e406103f"]->getclass_link($this->getContext($context, "class"));
                echo "</td>
                    <td class=\"last\">";
                // line 20
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["interface"]) {
                ...
                echo "                <tr>
                    <td>";
                // line 31
                echo $context["__internal_30af7d117510ba78a07f2b2311d790f6e406103f"]->getclass_link($this->getContext($context, "interface"));
                echo "</td>
                    <td class=\"last\">";
                // line 32
                echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "interface"), "shortdesc"), $this->getContext($context, "interface"));
                echo "</td>
                </tr>
            ";
            }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["exception"]) {
                ...
                echo "                <tr>
                    <td>";
                // line 43
                echo $context["__internal_30af7d117510ba78a07f2b2311d790f6e406103f"]->getclass_link($this->getContext($context, "exception"));
                echo "</td>
                    <td class=\"last\">";
                // line 44
                echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "exception"), "shortdesc"), $this->getContext($context, "exception"));
                echo "</td>
                </tr>
            ";
            }
