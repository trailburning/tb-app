...
class Route 
{
	...
	public function setGpxFileId($id) 
	{ 
		$this->gpx_file_id = $id; 
	}
	...
	{ 
		return $this->gpx_file_id; 
	}
	
	public function setCentroid($long, $lat) 
	{ 
		$this->centroid['long'] = $long; 
		$this->centroid['lat']=$lat; 
	}
