  ...
  var initialize = function() {
    ...
    function toggleSlide(elBtn) {
      if (bSlideFull) {
        ...
        $('#trail_overlay').css('top', 625 - 266);
        
        $('#trail_overlay .trailstats_panel').css('top', 24);
        $('#trail_overlay .trail_minimap').css('top', 24);
        $('#trail_overlay .trailaltitude_panel').css('top', 24);
      }
      else {
        bSlideFull = true;        
