...
//	  var nTransitionOffY = 35;
	  var nTransitionOffY = 120;
//	  var nTransitionOnY = 12;
	  var nTransitionOnY = 70;
...
/*
        ...
        if(docScroll >= nHeaderHeight) {
          $('#big_sponsor_bar').addClass('fixed');
                    
	      // move big bar
		  $('#big_sponsor_bar').css('top', -((nScrollY - nHeaderHeight) * nFactorY));	
		  
		  console.log(nScrollY+' : '+nTransitionOffY);
          ...
          $('#big_sponsor_bar').removeClass('fixed');
        }
