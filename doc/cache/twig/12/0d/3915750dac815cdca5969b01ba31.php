...
/* pages/index.twig */
class __TwigTemplate_120d3915750dac815cdca5969b01ba31 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"] = $this->env->loadTemplate("macros.twig");
        ...
        <dl id=\"index\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                ...
                if (("class" == $this->getContext($context, "type"))) {
                    // line 29
                    echo "<dt>";
                    echo $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"]->getclass_link($this->getContext($context, "value"));
                    if ($this->getContext($context, "has_namespaces")) {
                        echo " &mdash; <em>Class in namespace ";
                        echo $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"]->getnamespace_link($this->getAttribute($this->getContext($context, "value"), "namespace"));
                    }
                    echo "</em></dt>
                    <dd>";
                    // line 30
                    echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "value"), "shortdesc"), $this->getContext($context, "value"));
                    echo "</dd>";
                } elseif (("method" == $this->getContext($context, "type"))) {
                    // line 32
                    echo "<dt>";
                    echo $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"]->getmethod_link($this->getContext($context, "value"));
                    echo "() &mdash; <em>Method in class ";
                    echo $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"]->getclass_link($this->getAttribute($this->getContext($context, "value"), "class"));
                    echo "</em></dt>
                    <dd>";
                    // line 33
                    echo $this->env->getExtension('sami')->parseDesc($context, $this->getAttribute($this->getContext($context, "value"), "shortdesc"), $this->getAttribute($this->getContext($context, "value"), "class"));
                    echo "</dd>";
                } elseif (("property" == $this->getContext($context, "type"))) {
                    // line 35
                    echo "<dt>\$";
                    echo $context["__internal_230f99f0f8937479ca172d7239eb0efc4d409130"]->getproperty_link($this->getContext($context, "value"));
