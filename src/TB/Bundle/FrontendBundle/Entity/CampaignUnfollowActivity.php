 ...
 * @ORM\Entity 
 */
class CampaignUnfollowActivity extends Activity
{

    /**
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToOne(targetEntity="TB\Bundle\FrontendBundle\Entity\User", inversedBy="campaignUnfollowActivities")
     * @ORM\JoinColumns({
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToOne(targetEntity="TB\Bundle\FrontendBundle\Entity\Campaign", inversedBy="campaignUnfollowActivities")
     * @ORM\JoinColumns({
